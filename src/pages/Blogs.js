...
const Blogs = () => {
  ...
  return (
    <AnimationRevealPage>
      <HeaderLight />
      <p style="font-size: x-large">En este espacio va el contenido de 'Blogs'</p>
    </AnimationRevealPage>
  )
}

export default Blogs
//export default withAuthenticationRequired(Blogs, { onRedirecting: () => <Spinner animation="border" />, });