...
import { Profile, SacarEmail } from "components/Profile"
...
//const unEmail = SacarEmail()
//console.log(unEmail)
try {
  const unEmail = ProfileDatos()
  console.log(unEmail)
} catch (error) {
...
const elCorreo = () => {
  try {
    ...
    console.log('Este otro error', error)
  }
}
...
const Signup = ({
  ...
  headingText = "Completa tu registro",
